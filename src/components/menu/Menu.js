...
export const Menu = () => {
  return (
    <div className = "menu-component-wrapper">
      ...
      {/* LinkedIn Button */}
        <li>
          <a href = "https://www.github.com/jlaluces123" target = "_blank" className = "nav-item">
      ...
      {/* Github Button */}
        <li>
          <a href = "https://www.linkedin.com/in/jonathan-laluces/" target = "_blank" className = "nav-item">
            <svg style = {{ width : 40 , height : 40 }} viewBox="0 0 24 24">
